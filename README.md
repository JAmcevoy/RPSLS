...
- After submitting my project, it was brought to my attention that there was a bug in the system. The issue arose when a user made a selection and clicked "Shoot." Subsequently, if the user repeatedly clicked "Shoot" without making a new selection, the system retained the user's previous choice, allowing the game to continue with the outdated selection. Notably, this bug was not documented in the README.
